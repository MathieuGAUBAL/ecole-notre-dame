...
class AdminActu extends React.Component {
  constructor() {
    super();
    this.state = {
      actualite: [],
        ...
        .then(
          (res) => {
            fetch('http://localhost:3001/actualites',
              ...
              .then(res => res.json())
              .then(res => this.setState({ actualite: res }))
              .then(
                () => console.log(this.state.actualite)
              )
          }
        )
      }
          ...
          (res) => {
            ...
            .then(
              (res) => {
                this.setState({
                  snackbarOpen: true,
                  snackbarMessage: "Actualite ajouté."
                })
                setTimeout(() => {
  ...
  deleteActualite = () => {
    ...
    const actualite_id = this.state.actualite[this.state.deleteId].id
    console.log(actualite_id)
    fetch('http://localhost:3001/actualites/' + actualite_id,
      {
        method: 'DELETE',
        headers: new Headers({
          'authorization': 'Bearer ' + localStorage.getItem('token')
      ...
      .then(
        (res) => {
          this.setState({
            snackbarOpen: true,
            snackbarMessage: "Actualite supprimé"
          })
          setTimeout(() => {
            this.setState({ snackbarOpen: false })
          }, 3000);
  ...
  putActualite = () => {
    ...
    let actualite_id = this.state.actualite[this.state.modifedId].id
    console.log(actualite_id)
    fetch("http://localhost:3001/actualites/" + actualite_id,
    {
        method: 'PUT',
    ...
    .then(res => this.setState({ snackbarMessage: "Actualite modifié." }))
    .then(
      (res) => {
            ...
            <div class="main-content">
              ...
              <div class="main center">
                <div className="sub-title">
                  <h6>Vous pouvez remplir ce formulaire pour ajouter une nouvelle actualites !</h6>
                </div>
                <div className="form">
                  ...
                  <Form>
                    <FormGroup>
                      ...
                      <Input type="text" name="title" placeholder="Titre de l'actualite" onChange={this.handleChange} />
                    </FormGroup>
                    <FormGroup>
                      <Label for="exampleText">Description</Label>
                      <Input type="textarea" name="description" placeholder="Description de l'actualite" onChange={this.handleChange} />
                    </FormGroup>
                    <FormGroup>
                ...
                <div className="agenda">
                  ...
                  >
                    ...
                    <DialogContent>
                      <DialogContentText id="alert-dialog-description">
                        Etes vous sur de vouloir supprimer l'actualite ?
          </DialogContentText>
                    </DialogContent>
                    <DialogActions>
                      ...
                      <Button onClick={this.deleteActualite} color="primary" autoFocus>
                        Oui
          </Button>
                    </DialogActions>
                  </Dialog>
                  ...
                  <Dialog open={this.state.putModalOpen} onClose={this.handleClosePutModal} aria-labelledby="form-dialog-title">
                    ...
                    <DialogActions>
                      ...
                      <Button onClick={this.putActualite} color="primary">
                        Modifier
              </Button>
                    </DialogActions>
                  </Dialog>
